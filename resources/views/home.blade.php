        ...
        <div class="goobi-banner-details-wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-11 col-md-9 col-lg-7" data-aos="fade-up" data-aos-duration="1500">
                        <div class="goobi-banner-details">
                            ...
                            <h2 class="subtitle-main">The world's first patent technology colored glass for automobiles.
                            </h2>
                            <div class="goobi-btn-wrapper">
                                <a href="{{ route('car.details')}}" class="goobi-theme-btn-main">Car Details</a>
                ...
                <div class="goobi-scroll-down">
                    <a id="scroll-down" href="javascript:void(0);"><img src="{{asset('images/scroll-down-icon.svg') }}"
                            alt=""> </a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-lg-6" data-aos="fade-up" data-aos-duration="1500">
                    <div class="goobi-safe-details">
                        ...
                        <h6>Goobi Glass is the world's first colored glass for automobiles. We offer windows for any
                            type of vehicle with many colors to chose from.</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12" data-aos="fade-up" data-aos-duration="1500">
                    <div class="goobi-work-details">
                        ...
                        <p class="goobi-paragraph-text">Our team is comprised of talented experts who are passionate
                            about their work, and dedicated to deliver you high quality colored windows for your
                            automobile. </p>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-duration="1500">
                    <div class="goobi-core-values-details">
                        ...
                        <p class="goobi-paragraph-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-duration="1500">
                    <div class="goobi-core-values-details">
                        <h4>05</h4>
                        <h6 class="blog-title-main">Install the windows with your mechanic or a certified Goobi Glass
                            installer.</h6>
                        <p class="goobi-paragraph-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                            eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
